var bConnect = [0,0,0,0,0,0,0,0];
var recstatus = [0,0,0,0,0,0,0,0];
var lastvideostatus = [0,0,0,0,0,0,0,0];
var lastvideochn = [0,0,0,0,0,0,0,0];
var connstatus = 0;
var max_chn = 8;
var g_lang_id = 0;
var display_num;
...
function do_login()
{
	...
	TLNetDvrCtrl.OEMVersion   = 15;//~OEMVersion~
	...
	TLNetDvrCtrl.LangID = g_lang_id;//0 sc 1 eng 2 tch
	TLNetDvrCtrl.EnableMacModify(0);//~EnableMacModify~
	...
	if (true == ret)
	{
		...
		if (2 == g_lang_id)
		{
			document.getElementById("user").innerHTML = "<font><span style='float:left'>用戶:</span><span style='float:left'>" +TLNetDvrCtrl.UserName + "</span></font>";
		}
		else
		{
