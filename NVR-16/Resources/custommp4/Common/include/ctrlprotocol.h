...
#if defined(TL_9508) && defined(HANKE) && !defined(HANKE_SP3)
//pw 2010/8/23   wangcong
#if (defined(TL_9508) && defined(HANKE_SP5)) || (defined(TL_9504) && defined(HANKE_SP1)) || (defined(TL_9508_8M) && defined(HANKE_SP5))||(defined(TL_9508_8M) && defined(HANKE_SP10))
#define MAX_ALARM_IN_NUM		4
...
#else
#if defined(TL_9504_D1)&&defined(HANKE_SP4)
#define MAX_ALARM_IN_NUM	4 // 16			//fgpa:16 6446:4
#define MAX_ALARM_OUT_NUM	4 // 4	
#elif defined(SHENSHIYIN_SP1) || (defined(TIANMIN) && defined(TL_9508))
#define MAX_ALARM_IN_NUM		8
...
}PACK_NO_PADDING ifly_reset_picadjust_t;
...
}PACK_NO_PADDING ifly_framerate_list_t;
...
typedef struct  
{
 ...
 char userpw[32];   //邮箱密码
 u8  reserved[16];  //预留
}ifly_AlarmEmail_SMTP_t;					//dong	EMAIL_OPT
