...
HI_S32 SAMPLE_VDEC_CreateVdecChn(HI_S32 s32ChnID, SIZE_S *pstSize, PAYLOAD_TYPE_E enType)
{
	...
	switch(enType)
	{
		case PT_H264:
			...
			stAttr.stVdecVideoAttr.enMode = VIDEO_MODE_FRAME;//VIDEO_MODE_STREAM;//VIDEO_MODE_FRAME;
	...
	printf("HI_MPI_VDEC_CreateChn[%d] (wxh=%dx%d)\n", s32ChnID, pstSize->u32Width, pstSize->u32Height);
