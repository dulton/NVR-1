#ifndef _PAGE_IPCAMERA_EXT_SENSOR_H_
#define _PAGE_IPCAMERA_EXT_SENSOR_H_
...
struct IPCExt_SENSEOR_BASEITEM
{
	CStatic* pChnIndex;
...
struct IPCExt_SENSEOR_DEALITEM
{
	CStatic* pChnIndex;
...
class CPageIPCameraExtSensorAlarm:public CPageFrame
{
public:
	CPageIPCameraExtSensorAlarm(VD_PCRECT pRect,VD_PCSTR psz, emRealId real_id, VD_BITMAP* icon = NULL,CPage * pParent = NULL);
	~CPageIPCameraExtSensorAlarm();
...
#define TAB_NUM	2
	...
	SIPCExt_SensorAlarmPara*	pTabPara;
...
private:
	...
	IPCExt_SENSEOR_BASEITEM  tBasePage0[4+2];
	...
	IPCExt_SENSEOR_DEALITEM  tDealPage1[4+2];
