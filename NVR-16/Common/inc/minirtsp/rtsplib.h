...
#define RTSP_USER_AGENT		"minirtsp (by whrz)"
...
// rtsp player
extern Rtsp_t* RTSP_CLIENT_init(const char *url,char *user,char *pwd,int bInterleaved,int iBufferTime);
#if 0
...
extern int RTSP_read_message4(Rtsp_t *r);
extern int RTSP_read_message5(Rtsp_t *r, fRtpParsePacket frtp, fRtcpParsePacket frtcp);
