...
#define SDP_MAX_ATTR_NUM			(16)
#define SDP_MAX_ATTR_NAME_SIZE		(64)
#define SDP_MAX_ATTR_VALUE_SIZE		(512)
...
typedef struct _fmtp_attr
{
	...
	int sps_size;
	unsigned char sps[256];//unsigned char sps[64];//csp modify 20140221
	int pps_size;
	unsigned char pps[256];//unsigned char pps[64];//csp modify 20140221
}FmtpAttr_t;
