...
* configure mirco
**************************************************************************/
#define RTSP_SOCK_TIMEOUT			(4000) //  unit: ms , socket send and receive timeout
...
#define RTSP_FORCE_RTP_OVER_RTSP
#define RTSP_ENABLE_AUDIO			(FALSE) //rtsp server 使用使用音频

//csp modify 20140221
#define RTSP_ENABLE_RTCP			(TRUE)
...
#define RTSPC_RUNNING	(RTSP_NET_PROC)//(RTSP_NET_PROC | RTSP_DEC_PROC)
