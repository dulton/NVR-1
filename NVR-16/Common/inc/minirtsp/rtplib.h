...
//csp modify 20140220
//#define RTP_VIDEO_RECV_BUFFER_SIZE	(3072*1024)
//#define RTP_AUDIO_RECV_BUFFER_SIZE	(10000)
//#define RTP_VIDEO_RECV_BUFFER_SIZE	(1024*1024)
#define RTP_VIDEO_RECV_BUFFER_SIZE		(512*1024)
#define RTP_AUDIO_RECV_BUFFER_SIZE		(10*1024)
...
extern void RTP_set_type(Rtp_t *rtp, int type);
...
//extern int RTP_handle_packet(Rtp_t *rtp,void *payload,int size);/*rtp packet(contain rtsp interleaved header) and rtp packet size,only use for interleaved mode*/
extern int RTP_handle_packet_bufandnet(Rtp_t *rtp,char *payload,int payload_size,int received_size);//csp modify 20140221
...
//#define RTP_HANDLE_ONERECV  RTP_handle_packet_nortpbuf_oneRecv
