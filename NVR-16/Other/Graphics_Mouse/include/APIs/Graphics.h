...
typedef enum
{
	EM_GRAPHICS_VGA_800_600 = 0,
	EM_GRAPHICS_VGA_1024_768,
	EM_GRAPHICS_VGA_1280_1024,
	//
}EMGRAPHICSVGARESOL;
...
int GraphicsGetCursorPos(PPOINT pPoint);
//int GraphicsSetCursorPos(int x, int y);
...
/// \return 0 设置成功
/// \retval < 0 设置失败
int GraphicsDeFlicker(RECT *pRect, int resv);
